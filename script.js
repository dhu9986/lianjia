document.addEventListener('DOMContentLoaded', () => {
    // 员工名单 (请替换为实际的员工姓名)
    const employees = ["成露华", "姚慧娉","于明飞","刘冬冬","袁昂","黄继","郑智","刘款款","江波","张委","赵明","沈伟伟","金涛","郑淮丰","何玉龙","何玲","胡玮炀","夏文明","李金","李路远","张盼楠","刘寿欢","魏冉","刘雪东","张春红","谢军","邹维永","奂丽","汤迎迎","黄庆妹","郭文静","吴秀平","林志良","王仲伟","顾存仓","马浩杰","庞夫强","董新军","韩霞","陈佳龙","刘佳欣","吴霜","张羽","康博","李玲玉","熬海江"];
